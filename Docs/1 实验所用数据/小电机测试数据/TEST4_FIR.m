% 1. 读取数据并验证
% try
%     data = readmatrix('2025-04-28 102547.csv'); % 尝试读取纯数值数据
% catch
%     data_table = readtable('2025-04-28 102547.csv'); % 如果有表头，使用readtable
%     data = table2array(data_table); % 转换为数值矩阵
% end
data = readmatrix('2025-04-28 091554.csv'); % 尝试读取纯数值数据
% 提取三轴数据
x = data(:,1);
y = data(:,2);
z = data(:,3);
